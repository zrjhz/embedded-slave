...
public:
	...
	uint8_t command34[ 8 ] = { 0x55,0x08,0x10 ,0x01 ,0x00 ,0x00 ,0x00 ,0xbb };	/*TFT显示图片向上翻命令			不修改*/
	uint8_t command35[ 8 ] = { 0x55,0x08,0x10 ,0x02 ,0x00 ,0x00 ,0x00 ,0xbb };	/*TFT显示图片向下翻命令			不修改*/
